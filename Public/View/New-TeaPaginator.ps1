function New-TeaPaginator {
    ...
    .PARAMETER Style
        Tea style applied to the full text node (Numeric), inactive dots (Dots),
        or inactive tab labels (Tabs).

    .PARAMETER ActiveStyle
        Tea style applied to the active element. Falls back to Style when null.
    ...
    .EXAMPLE
        # Numeric pagination
        New-TeaPaginator -CurrentPage $model.Page -PageCount $model.TotalPages

    .EXAMPLE
        # Dot pagination with defaults
        New-TeaPaginator -Dots -CurrentPage $model.Page -PageCount $model.TotalPages

    .EXAMPLE
        # Dot pagination - ASCII-safe for Windows PowerShell 5.1
        New-TeaPaginator -Dots -CurrentPage 3 -PageCount 5 -FilledDot '*' -EmptyDot '-'
    ...
    .NOTES
        ...
        dot chars to render correctly. New-TeaTerminalDriver sets this automatically.
...
Set-Alias -Name TeaPaginator         -Value New-TeaPaginator
