function New-TeaTextarea {
    ...
    .PARAMETER Style
        Tea style applied to each line when the widget is not focused.

    .PARAMETER FocusedStyle
        Tea style applied to each line when the widget is focused. When omitted
    ...
    .PARAMETER FocusedBoxStyle
        ...
        Box node. Use to add a visible border around the focused area, e.g.:
            ...
            New-TeaStyle -Border 'Rounded' -Foreground 'BrightWhite'
    ...
    .EXAMPLE
        New-TeaTextarea -Lines $model.Lines -CursorRow $model.Row -CursorCol $model.Col -Focused
...
Set-Alias -Name TeaTextarea          -Value New-TeaTextarea
