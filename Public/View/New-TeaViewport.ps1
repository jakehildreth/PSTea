function New-TeaViewport {
    ...
    .PARAMETER Style
        Optional Tea style applied to each line.

    .OUTPUTS
        PSCustomObject - Box view node.

    .EXAMPLE
        New-TeaViewport -Lines $model.Lines -ScrollOffset $model.Scroll -MaxVisible 20

    .EXAMPLE
        $dimStyle = New-TeaStyle -Foreground 'BrightBlack'
        New-TeaViewport -Lines $logLines -ScrollOffset $model.Top -MaxVisible 15 -Style $dimStyle
...
Set-Alias -Name TeaViewport          -Value New-TeaViewport
