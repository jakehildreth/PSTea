function New-TeaComponentMsg {
    ...
    .DESCRIPTION
        ...
        Elm Language's Cmd.map and Html.map approach for nested programs.

    .PARAMETER ComponentId
        The identifier of the target component. Must match the ComponentId used in
        the corresponding New-TeaComponent call.
    ...
    .EXAMPLE
        ...
        $msg = New-TeaComponentMsg -ComponentId 'search' -Msg ([PSCustomObject]@{
            Type = 'CharInput'
            Char = $key.KeyChar
        })
