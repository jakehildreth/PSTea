function New-TeaSpinner {
    ...
    .EXAMPLE
        New-TeaSpinner -Frame $model.Frame -Variant Braille -Style (New-TeaStyle -Foreground 'Cyan')
...
Set-Alias -Name TeaSpinner           -Value New-TeaSpinner
