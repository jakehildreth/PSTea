function New-TeaTextInput {
    ...
    .PARAMETER Style
        Tea style applied when the field is not focused.

    .PARAMETER FocusedStyle
        Tea style applied when the field is focused. When omitted and -Focused
    ...
    .EXAMPLE
        New-TeaTextInput -Value $model.Input -CursorPos $model.Cursor -Focused
...
Set-Alias -Name TeaTextInput         -Value New-TeaTextInput
