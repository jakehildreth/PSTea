function New-TeaTimerSub {
    ...
    .DESCRIPTION
        ...
        Timer state (last-fired timestamp) is managed by Invoke-TeaSubscriptions
    ...
    .EXAMPLE
        New-TeaTimerSub -IntervalMs 100 -Handler { [PSCustomObject]@{ Type='Frame' } }
...
Set-Alias -Name TeaTimerSub          -Value New-TeaTimerSub
