function New-ElmKeySub {
    ...
    .PARAMETER Key
        ...
        See ConvertFrom-ElmKeyString for the full alias list.
    ...
    .EXAMPLE
        New-ElmKeySub -Key 'UpArrow' -Handler { 'MoveUp' }

    .EXAMPLE
        New-ElmKeySub -Key 'Ctrl+C' -Handler { [PSCustomObject]@{ Type='Quit' } }
    ...
    $parsed = ConvertFrom-ElmKeyString -KeyString $Key
