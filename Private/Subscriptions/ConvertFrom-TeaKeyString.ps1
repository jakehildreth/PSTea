function ConvertFrom-TeaKeyString {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        ConvertFrom-TeaKeyString -KeyString 'Q'
        # Key = [ConsoleKey]::Q, Modifiers = 0

    .EXAMPLE
        ConvertFrom-TeaKeyString -KeyString 'Ctrl+Shift+N'
        # Key = [ConsoleKey]::N, Modifiers = Control | Shift

    .NOTES
        Used internally by New-TeaKeySub to build typed subscription objects.
    #>
    [CmdletBinding()]
    param(
