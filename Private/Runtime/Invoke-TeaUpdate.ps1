function Invoke-TeaUpdate {
    ...
    .DESCRIPTION
        ...
        Performs a deep copy of the model via Copy-TeaModel before passing it to
    ...
    .NOTES
        The Cmd return value is inspected by Invoke-TeaEventLoop to determine whether
    ...
    $modelCopy = Copy-TeaModel -Model $Model
