function Compare-TeaViewTree {
    <#
    .SYNOPSIS
        Diffs two measured view trees and returns a list of patches.

    .DESCRIPTION
        Compares an old and new measured view tree (produced by Measure-TeaViewTree)
        ...
        Compare-TeaViewTree does not emit Clear patches. The caller should treat
    ...
    .EXAMPLE
        $measured = Measure-TeaViewTree -Root $view -TermWidth 80 -TermHeight 24
        $patches  = Compare-TeaViewTree -OldTree $prevMeasured -NewTree $measured
